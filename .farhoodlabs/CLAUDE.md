...
| PR branches | `skill-pat-feature`, `skill-scan-refresh`, `feat/plugin-tool-events`, `feat/company-portability-complete`, `fix/far-108-k8s-adapter-reaper-liveness` — open PRs to upstream, never rebase onto master/local. |
